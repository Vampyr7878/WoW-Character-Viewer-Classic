...
{
    class TaurenFemale : CharacterModel
    {
        enum Geosets
        {
            Mane1,
        ...
        public TaurenFemale()
            : base(@"Character\Tauren\Female\TaurenFemale.xml")
        {
        ...
        public override void BearForm(bool shapeshift)
        {
            ...
            Owlbear = false;
            form.Initialize("DruidBearTauren", "DruidTaurenBearSkin", null, null, @"Creature\DruidBear\");
        }
        ...
        public override void CatForm(bool shapeshift)
        {
            Shapeshift = shapeshift;
            Owlbear = false;
            form.Initialize("DruidCatTauren", "DruidCatTaurenSkinBrown", null, null, @"Creature\DruidCat\");
        }
        ...
        public override void MoonkinForm(bool shapeshift)
        {
            Shapeshift = shapeshift;
            Owlbear = shapeshift;
            moonkin.Initialize("DruidOwlbearTauren", "DruidOwlBearTASkin1", "DruidOwlBearTASkin2", null, @"Creature\DruidOwlbear\", components[3], components[4], Gear[16], Gear[17]);
        }
