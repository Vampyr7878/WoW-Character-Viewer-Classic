...
{
    public partial class BackItemsDialog : Form
    {
        Items items;
        ItemsItem selected;
        ItemsItem item;
        ...
        public void GetItemList(string characterRace, string characterClass, CharacterModel character)
        {
            ...
            using (StreamReader reader = new StreamReader(@"Data\BackItems.xml"))
            {
        ...
        void BackItemsDialog_LocationChanged(object sender, EventArgs e)
        {
            ...
            {
                backTooltip.Item = selected;
                backTooltip.Show(selected.Name, itemsListBox, itemsListBox.Size.Width, 0);
            }
        }
